...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="relative min-h-[50vh] sm:min-h-screen flex items-center bg-[#f5ede0] font-quicksand"
    >

      {/* shape fora do container */}
      <div className="absolute top-0 right-0 bottom-0 z-0 pointer-events-none hidden sm:block">
        <img
          src={rightShape}
          alt="shape-img"
      ...
      <div className="xl:container flex items-center">
        ...
        <div className="max-w-xl space-y-8 z-10 relative mx-auto text-center md:text-left flex flex-col items-center md:items-start">
          ...
          <h1 className="text-4xl md:text-8xl font-bold text-gray-600 leading-tight">
            Curuka <span className="text-orange-400">Kid's</span> <br />
          </h1>
          <p className="text-5xl text-gray-600 max-w-md leading-relaxed !m-0">
            Segurança Infantil
          </p>
        ...
        <div className="hidden lg:flex relative flex-1 justify-center z-10 overflow-visible">
          <div className="relative w-64 md:w-[650px] h-64 md:h-[650px] mt-6">
            <img
              src={heroKids}
